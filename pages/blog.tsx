...
export default function Blog({ posts }: any) {
  ...
  return (
    <Container
      title="Blog · Emanuele Gurini - Software Developer, curious mind, and creator"
    ...
    >
      <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16">
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          {`You can use the filter to sort articles by category, tag, or author, or you can use the search bar to find specific articles.`}
        </p>
        ...
        <Suspense fallback={null}>
          ...
          {filteredBlogPosts.map((post: any, index: any) => {
            return (
              <BlogPost
                key={"blog-post-" + index}
                data={post}
